...
public class TestPIMPage extends BasePage {
	...
	public void addEmployeeThenVeify() throws Exception {
		...
		CommonUtils.enterValue(PIMPage.getLastName(), "Akki", true);
	...
	@Test(description = "Verify that an employee can be deleted successfully",dependsOnMethods= {"editEmployeeDetails"},groups= {"Smoke"}, priority = 3)
